...
class KiwiConfigTest {
    ...
    void shouldUseDefaultValuesWhenNotProvided() {
        ...
        // JWT defaults
        // secret will be auto-generated because default is CHANGE_ME_NOW_32+chars_secret
        // but the generation only happens when env value is null/blank/default
        // Since we didn't provide JWT_SECRET, it will be null -> resolveJwtSecret returns generated
