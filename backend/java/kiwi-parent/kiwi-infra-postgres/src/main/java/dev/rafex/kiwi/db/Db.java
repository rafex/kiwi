...
public final class Db {
	...
	/**
	 * Initialize the database connection pool with the provided configuration. This
	 * method must be called before any call to {@link #dataSource()} or
	 * {@link #databaseClient()}. If not called, the configuration will be loaded
	 * from {@link KiwiConfig#load()} on first access.
	 */
